...
class MentionLocalizationEvaluator(Evaluator):
    ...
    def compute_metrics(self, ground_truth, predictions):
        ...
        # mention_eval = jerex.evaluation.scoring.score(ground_truth, predictions, print_results=False) #MEMO print false
...
class CoreferenceResolutionEvaluator(Evaluator):
    ...
    def compute_metrics(self, ground_truth, predictions):
        ...
        # coref_eval = scoring.score(ground_truth, predictions, print_results=False) # MEMO print false
...
class EntityClassificationEvaluator(Evaluator):
    ...
    def compute_metrics(self, ground_truth, predictions):
        ...
        # entity_eval = scoring.score(ground_truth, predictions, type_idx=1, print_results=False) #MEMO print false
...
class RelClassificationEvaluator(Evaluator):
    ...
    def compute_metrics(self, ground_truth, predictions):
        ...
        # rel_eval = scoring.score(ground_truth, predictions, type_idx=2, print_results=False) # MEMO print False
    ...
    def store_predictions(self, predictions, documents, path):
        ...
        #MEMO prediction 저장 한국어되게끔
        with open(path, 'w') as predictions_file:
            json.dump(results, predictions_file, ensure_ascii=False)
