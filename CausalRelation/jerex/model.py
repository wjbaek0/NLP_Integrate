...
class JEREXModel(pl.LightningModule):
    ...
    def __init__(self, model_type: str, tokenizer_path: str, encoder_path: str = None,
                 ...
                 token_dist_embeddings_count: int = 10000, #MEMO 수정
                #  token_dist_embeddings_count: int = 2000, #MEMO 수정
                 ...
                 position_embeddings_count: int = 300, #MEMO 수정
                #  position_embeddings_count: int = 2000, #MEMO 수정
...
def train(cfg: TrainConfig):
    ...
    data_module = DocREDDataModule(types_path=cfg.datasets.types_path, tokenizer=tokenizer,
                                   ...
                                   pred_path=cfg.datasets.pred_path, ##
...
def test(cfg: TestConfig):
    ...
    # test
    data_module.setup('test')
    # trainer.test(model, datamodule=data_module, verbose=False) # MEMO verbose=False
    trainer.test(model, datamodule=data_module, verbose=True) # MEMO verbose=False
