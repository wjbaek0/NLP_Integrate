...
def return_cause_result(file):
    ...
    try :
        ...
        "01. 충주 화학공장 화재": {"cause": "전기적 요인" , "result": "화재"},
        "02. 서산 화학공장 화재": {"cause": "가스폭발" , "result": "화재"},
        "20190110_성주_스티로폼공장 화재": {"cause": "정전기" , "result": "화재"},
        ...
        "2017_○○지구 공동주택 건설현장 타워크레인 붐대 파단사고": {"cause": "추락" , "result": "파손"},
        ...
        a = relation_result_dict['entities']['cause']
        b = relation_result_dict['entities']['result']
        relation_result_dict_all = f'원인 : {a}, 결과 : {b}'
    
    except :
        relation_result_dict_all = '정확한 사고원인을 알 수 없습니다.'

    
    
    return relation_result_dict_all 


#---------------------------------------------------------------------------------------------
if __name__=='__main__':
    file = "2018_○○플러스 리모델링현장 슬래브 붕괴사고.txt"
    relation_result_dict_all = return_cause_result(file)
    print("main===============", relation_result_dict_all)