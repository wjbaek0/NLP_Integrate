...
checkpoint = torch.load("./best-epoch-217-step-25600-acc-0.979-loss-664.879.pth", map_location=torch.device('cpu'))
...
def inference(sum_txt):
    ...
    return ner_word_list, ner_sentence_list
